...
export default function TazCommitteeFormPage() {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      setArchivedForms(prev => prev.filter(f => f.id !== formToDelete));
      if (editingFormId === formToDelete) {
        resetForm();
      }
    } catch (err: any) {
  ...
  return (
    <AuthGuard>
      <div className="p-4 sm:p-6 lg:p-8 max-w-[1600px] mx-auto space-y-6 font-sans">
        ...
        <ConfirmDialog
          isOpen={!!formToDelete}
          title="Delete TAZ Form"
          description="Are you sure you want to delete this form record?"
