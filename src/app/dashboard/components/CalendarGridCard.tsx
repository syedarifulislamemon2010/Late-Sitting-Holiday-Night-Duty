...
export function CalendarGridCard({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap sm:flex-nowrap items-center gap-1.5 w-full mb-4">
        {MONTH_NAMES.map((name, idx) => (
          <Button
            ...
            size="sm"
            className="flex-1 min-w-0 text-center px-1 py-1.5 text-[11px] sm:text-xs font-bold"
          >
            {name}
          </Button>
        ))}
