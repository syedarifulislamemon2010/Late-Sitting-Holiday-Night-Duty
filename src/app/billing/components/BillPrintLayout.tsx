        ...
        <html>
          <head>
            ...
            <style>
              ...
              th, td { border: 1px solid #000; padding: 4.5px; font-size: 14px; line-height: 1.05; }
                ...
                <div>
                  ...
                  <div className="flex-1 flex flex-col justify-between mt-2">
                    <div>
                                    ...
                                    {(() => {
                                      ...
                                      return (
                                        <>
                                          ...
                                          <p className="text-[12px] text-slate-800 font-normal mt-0.5">({getShortDesignation(s.designation)})</p>
                                        </>
                                      );
                                    })()}
                                  </td>
                                  <td className="border border-black p-1.5 text-center font-normal" style={{ border: '1px solid #000', padding: '3.5px', fontSize: '10px', lineHeight: '1.0' }}>
                      ...
                      <div className="text-left pt-3 mt-3 space-y-1.5" style={{ fontFamily: 'SolaimanLipi', fontSize: '14px', lineHeight: '1.05' }}>
                        <p className="font-bold text-black">কথায়: {viewingOrder.content?.grandTotalInWords || ''} মাত্র।</p>
                        <p className="text-justify leading-normal text-black" style={{ fontFamily: 'SolaimanLipi', fontSize: '14px', lineHeight: '1.05', textAlign: 'justify' }}>
                  ...
                  <div className="w-full text-left mt-4 pl-1 no-break-inside" style={{ fontFamily: 'SolaimanLipi', fontSize: '14px', lineHeight: '1.0' }}>
                              ...
                              <td className="border border-black p-1 text-left pl-2 font-normal" style={{ border: '1px solid #000', padding: '3px', textAlign: 'left', paddingLeft: '6px', lineHeight: '1.05' }}>
                                {(() => {
                                  ...
                                  return (
                                    <>
                                      <p className="font-normal">{displayName.startsWith('জনাব') ? displayName : `জনাব ${displayName}`}</p>
                                      <p className="text-[11px] text-slate-800 font-normal mt-0.5">({getShortDesignation(d.designation)})</p>
                                    </>
                                  );
                                })()}
                              </td>
