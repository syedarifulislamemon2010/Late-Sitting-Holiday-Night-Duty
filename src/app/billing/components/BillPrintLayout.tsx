            ...
            >
              <div className="flex flex-col h-full justify-between">
                <div>
                  ...
                  <div className="flex-1 flex flex-col justify-between mt-2">
                    <div>
                      ...
                      <div className="mt-2.5">
                        <p className="text-justify leading-normal text-black text-[14px]" style={{ fontFamily: 'SolaimanLipi', fontSize: '14px', lineHeight: '1.6', textIndent: '0.5in', textAlign: 'justify' }}>
                      ...
                      <div className="text-left pt-3 mt-3 space-y-2.5" style={{ fontFamily: 'SolaimanLipi', fontSize: '14px', lineHeight: '1.6' }}>
                        <p className="font-bold text-black">কথায়: {viewingOrder.content?.grandTotalInWords || ''} মাত্র।</p>
                        <p className="text-justify leading-normal text-black" style={{ fontFamily: 'SolaimanLipi', fontSize: '14px', lineHeight: '1.6', textAlign: 'justify' }}>
                  ...
                  <div className="w-full text-left mt-6 pl-1 no-break-inside" style={{ fontFamily: 'SolaimanLipi', fontSize: '14px', lineHeight: '1.0' }}>
