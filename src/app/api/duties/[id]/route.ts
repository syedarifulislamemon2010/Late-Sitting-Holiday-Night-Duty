...
import { dutyUpdateSchema } from '@/validations/duty.schema';
...
export async function PUT(
  ...
  try {
    ...
    const validation = dutyUpdateSchema.safeParse(body);
    ...
    const result = await DutyService.updateDuty(user, dutyId, validation.data, { ipAddress, userAgent });
