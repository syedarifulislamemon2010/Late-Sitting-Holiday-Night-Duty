...
export const extractNickname = (nameStr: string): string => {
  ...
  if (clean.toLowerCase().includes('admin') || clean.includes('এডমিন') || clean === 'System Admin') return 'Admin';
  ...
  const prefixes = [
    'জনাব', 'জনাবা', 'মুhammad', 'muhammad', 'মুহাম্মদ', 'মোহাম্মদ', 'মোহাম্মাদ', 'মো', 'মোঃ', 'মোহা', 'শ্রী', 'ডা', 'ডাঃ', 'ড', 'ডক্টর', 'মহম্মদ', 'মিসেস', 'মিস', 'এসএম', 'সৈয়দ', 'সৈয়দ'
  ];
