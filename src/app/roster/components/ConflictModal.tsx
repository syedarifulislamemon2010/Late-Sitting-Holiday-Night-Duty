...
interface ConflictModalProps {
  data: {
    message: string;
    conflicts?: Array<{ date: string; type: string }>;
  } | null;
  onClose: () => void;
  onRedirectToConflicting: () => void;
    ...
    >
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl max-w-lg w-full p-6 shadow-2xl space-y-4 font-sans">
        <div className="flex items-center gap-3 text-amber-600 dark:text-amber-400">
          ...
          <div>
            <h3 id="conflict-dialog-title" className="font-extrabold text-base text-slate-800 dark:text-slate-100">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-end gap-2.5 pt-2">
          ...
          <button
            type="button"
            onClick={onRedirectToConflicting}
            aria-label="তালিকায় কনফ্লিক্টিং ডাটা দেখুন"
          ...
          <button
            ...
            aria-label="কনফ্লিক্টিং ডাটা মুছে সেভ করুন"
