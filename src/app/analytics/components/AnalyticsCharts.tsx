  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 font-sans">
      ...
      {!isEmployee && personalAllowanceTrend.length > 0 && (
        <div className="bg-gradient-to-br from-white to-blue-50/10 rounded-3xl p-6 border border-slate-100/80 shadow-sm space-y-4 lg:col-span-2">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-bold text-[#0b5e9e]">আমার প্রাপ্ত ভাতার ধারা (My Allowance Trend)</h3>
      ...
      {!isEmployee && (
        <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm space-y-4">
          <h3 className="text-sm font-bold text-slate-800">সর্বোচ্চ ডিউটি সম্পাদনকারী (Top Performers - Count Only)</h3>
          <div className="h-72 w-full">
      ...
      <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm space-y-4">
        <h3 className="text-sm font-bold text-slate-800">তারিখ অনুযায়ী বিল ছাড়ার পরিমাণ (Daily Bill Releases)</h3>
        <div className="h-72 w-full">
      ...
      <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm space-y-4 flex flex-col justify-between">
        <div>
          <h3 className="text-sm font-bold text-slate-800 mb-4">কর্মকর্তা অনুযায়ী বিল ছাড়ার সংখ্যা (Released Bills per Employee)</h3>
          <div className="overflow-y-auto max-h-72 pr-2 no-scrollbar space-y-2.5">
            {employeeBillCounts.length === 0 ? (
              ...
              employeeBillCounts.map((emp, idx) => (
                <div key={emp.employeeName} className="flex items-center justify-between border-b border-slate-50 pb-2">
                  <div className="flex items-center gap-2">
                    <span className="w-5 h-5 flex items-center justify-center bg-blue-50 text-[#0b5e9e] text-[10px] font-bold rounded-full">
                      {toBanglaDigits((idx + 1).toString())}
                    </span>
                    <span className="font-bold text-slate-700">{emp.employeeName}</span>
                  </div>
