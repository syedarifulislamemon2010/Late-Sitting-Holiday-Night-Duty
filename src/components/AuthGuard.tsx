    ...
    return (
      ...
      >
        ...
        <div className="flex-1 flex items-center justify-center w-full my-6 z-10">
          <div className="w-full max-w-[420px] bg-white/95 backdrop-blur-2xl rounded-[32px] shadow-2xl shadow-blue-900/15 border border-white/80 overflow-hidden p-6 sm:p-8 space-y-6 flex flex-col justify-between">
