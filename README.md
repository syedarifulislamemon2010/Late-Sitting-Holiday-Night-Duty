...
9. **AuditLog (অডিট ট্র্যাকিং):** সিস্টেমের যেকোনো পরিবর্তনের ইউজারনেম, আইপি ও সময়ের বিস্তারিত রেকর্ড রাখে।
10. **Feedback & FeedbackMessage (ফিডব্যাক ও সহায়তা):** সহায়তা টিকিট এবং এর আন্ডারে হওয়া চ্যাট রেকর্ড সংরক্ষণ করে।
11. **Chat, ChatParticipant & ChatMessage (মেসেঞ্জার চ্যাট):** ইনস্ট্যান্ট মেসেঞ্জারে AES-256 এন্ক্রিপ্টেড বার্তা, ফাইল ও আনসেন্ডের বিবরণ সংরক্ষণ করে।
12. **LeaveApplication (ছুটির আবেদন):** নৈমিত্তিক ও স্টেশন ছুটির ডাইনামিক তথ্য ও স্যান্ডউইচ ক্যালকুলেশন রেকর্ড ধারণ করে।
13. **LunchBill (লাঞ্চ বিল):** সেলের প্রতি মাসের জেনারেটকৃত লাঞ্চ ভাতা বিল ও কর্মকর্তাদের কার্যদিবসের JSON ডাটা ধারণ করে। ইউনিক কনস্ট্রেইন্ট: `@@unique([month, cellId])` যা একই সেলের এক মাসে একাধিক এন্ট্রি হওয়া রোধ করে।
